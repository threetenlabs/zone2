...
class AnimateIcon extends StatefulWidget {
  ...
  /// [toggled] is an optional parameter to control the toggle state of the icon
  final bool? toggled;

  /// [delay] is an optional parameter to specify the delay before toggling the animation
  ...
  const AnimateIcon({
    ...
    this.toolTip,
    this.toggled,
    this.delay, // Add the delay parameter here
  });
...
class _AnimateIconState extends State<AnimateIcon> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        if (widget.iconType == IconType.animatedOnTap) {
          iconTypeAction();
        }
        ...
        child: Lottie.asset(
          ...
          onLoaded: (composition) {
            ...
            if (widget.iconType == IconType.continueAnimation ||
                widget.iconType == IconType.toggleIcon) {
              iconTypeAction();
            }
          },
          animate:
              widget.iconType == IconType.animatedOnTap || widget.iconType == IconType.toggleIcon,
